  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center ">
        <div className="w-full h-auto mt-32 pt-2 flex flex-wrap justify-between items-center bg-white fixed order-1 md:w-full md:h-20 md:mt-14 lg:w-11/12">
          {/* User Logo & Brand */}
          ...
          <ul className="hidden login-signup-language-md-config lg:justify-end lg:gap-5 ">
            <li className="md:w-24 border ring-1 ring-pink-500 rounded-xl p-2 bg-white hover:bg-white cursor-pointer hover:p-4 duration-300 text-pink-500">
              login
            </li>
            <li className="md:w-24 border rounded-xl p-2 bg-pink-500 hover:bg-pink-500 cursor-pointer hover:p-4 duration-300 text-white">
              Sign Up
            </li>
