  ...
  return (
    <>
      <div className="w-full h-auto flex justify-center items-center">
        ...
        <div className="w-6/12 md:h-[250px] flex md:justify-between md:flex-col">
          <p className="text-xl font-bold lg:text-3xl text-gray-700 px-2">
            It's the food and groceries you love, delivered
          </p>

          {/*input*/}
          <div className="hidden hidden-in-sm">
            <input type="text" className="w-full h-10 rounded-md focus:outline-none border border-gray-300 in-md-input"/>
